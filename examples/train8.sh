...
mp_size=4   # Must be 1 for now
dp_size=1
pp_size=1
num_experts=8
k_experts=1

exp_name=test-opensae-trainer-exp8-quadruple
...
--save_every 1000 \
--save_dir /data/hujw/CHECKPOINTSMOE8 \
--load_dir /data/hujw/CHECKPOINTSMOE8 \
...
SAE_CONFIG="--expansion_factor 512
--k 128
--normalize True
--shift_back False
"
