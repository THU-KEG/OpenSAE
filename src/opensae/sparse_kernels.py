...
# Below are the functions that are never used in the codebase
# Copied from OpenAI: https://github.com/openai/sparse_autoencoder/blob/main/sparse_autoencoder/kernels.py
